...
• Began documenting learnings on Medium & Twitter, planting the seeds for current audience.`,
  ...
  // === 2019 =========================================================
  {
    title: "2019",
    content: `
• Ran side-hustle social-media campaigns for local businesses while finishing UK studies.  
• First taste of outbound sales: cold-pitched 40 SMBs, closed 8 web-design gigs.  
• Started public journaling habit that later migrated to Bear Blog.`,
  },
];